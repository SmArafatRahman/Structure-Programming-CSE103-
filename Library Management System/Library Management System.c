...
char catagories[][50]= {"Computer","Electronics","Electrical","Civil","Mechnnical","Architecture","History","Library Management","Biographs","Academic English","Biology"};
...
//    show_mouse();
    ...
    case '7':
    {
        ...
        gotoxy(16,5);
        printf("\n Brought to you by Team Avengers");
        gotoxy(16,7);
        printf("\tCode with C Team Avengers");
        gotoxy(16,8);
        printf("******************************************");
        gotoxy(16,10);
        printf("*******************************************");
...
//flushall();
    ...
    default:
    {
        ...
        printf("\n\t\tFor Assistance Please Contact Team Avengers\n\t\tOr Call Our Helpline Number");
        if(getch())
            mainmenu();
    }
...
void addbooks(void)    //funtion that add books
{
    ...
    gotoxy(20,21);
    printf("\xDB\xDB\xDB\xDB\xB2 8. Library Management");
    gotoxy(20,23);
    printf("\xDB\xDB\xDB\xDB\xB2 9. Biograhs");
    gotoxy(20,25);
    printf("\xDB\xDB\xDB\xDB\xB2 10. Academic English");
    gotoxy(20,27);
    printf("\xDB\xDB\xDB\xDB\xB2 11. Biology");
    gotoxy(20,29);
    printf("\xDB\xDB\xDB\xDB\xB2 12. Back to main menu");
    gotoxy(20,31);
    printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
    gotoxy(20,33);
    printf("Enter your choice:");
    ...
    if(getdata()==1)
    {
        ...
        fseek(fp,0,SEEK_END);
        fwrite(&s,sizeof(a),1,fp);/*fwrite(){while(gets()!='size){}*/
        fclose(fp);
        gotoxy(21,14);
